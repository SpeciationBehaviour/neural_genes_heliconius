...
#removed --sjdbGTFtagExonParentTranscript Parent  #only for gff
...
#make table MELPOMENE (problem overlapping genes.. that’s why so many ambiguous, before it was 0..)
cd /data/home/wolfproj/wolfproj-06/5_HTseq/Adults/MPtoCuff/
#remove slurm.out
FILES=$(ls -t -v *.txt | tr '\n' ' ');
...
#and so for 156h APF and 60h APF
