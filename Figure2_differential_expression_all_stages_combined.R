...
##################GRAPHS
#change parameters for making graphs
...
###ALEX'S SCRIPT
#Set active Chromosome and then withdraw p values, repeat for next hromosome
