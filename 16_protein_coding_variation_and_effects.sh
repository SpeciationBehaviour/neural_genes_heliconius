...
#INTERSECT NOW WITH VARIANTS INFERRED FROM GENOME RESEQ. DATA #”fixed“ = present (homozygous) in 8 individuals
...
#annotate vcf files (keep only protein-coding transcripts)
#MP
